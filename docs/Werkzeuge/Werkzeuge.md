...
Der Menüpunkt „Werkzeug“ stellt eine Übersicht über vorab verfügbare und in der App hinterlegte Werkzeuge (siehe den Messstab) sowie der durch den Nutzer kalibrierten und eingemessenen Werkzeuge der jeweiligen Baumaschine dar.
Der Sensor und der mitgelieferte Messstab (Sensor montiert) sind als Werkzeuge standardmäßig hinterlegt, um Punkte aufnehmen zu können.
...
Mit der Funktion "Werkzeug speichern" können Sie entweder ein neues Werkzeug anlegen oder Ihr aktuell aktives Werkzeug überschreiben (falls Sie sich eingangs vermessen haben sollten).
Aktuell zur Verfügung stehen folgende Werkzeuge zur Verfügung: Messstab, Löffel, Schaufel und Schild. Die Kalibrierung erfolgt über das Eingabe- und Antastverfahren. Für den Messstab ist eine Höhenangabe erforderlich. Der Schild kann nur durch das Antastverfahren hinterlegt werden.
