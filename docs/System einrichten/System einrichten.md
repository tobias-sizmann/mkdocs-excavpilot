...
Das Tablet wird mit der excav PILOT App einsatzbereit mitgeliefert. Die Geräte wurden vorab testweise mit der App des Tablets gekoppelt. Um zu starten und die Geräte zu koppeln, benötigen Sie auf dem Tablet eine aktive Bluetooth-Verbindung sowie eine aktive Internetverbindung über WLAN oder mobile Daten, da die Kommunikation beider Geräte zum Tablet über Bluetooth Low Energy erfolgt. Es können standardmäßig zwei Geräte verbunden werden: der für die Arbeit unabdingbare GNSS-Sensor und das als Hilfestellung dienende LED-Anzeigekreuz.
...
Es wird zuerst die Sensoreinheit angezeigt, die dem System bereits bekannt war bzw. zuletzt verbunden war. In der Regel wurde zuvor nur ein Sensor verbunden, der folglich wieder vorgeschlagen wird. Betätigen Sie „Scannen“ und wählen Sie den angezeigten Sensor aus.
...
Für die Einrichtung der NTRIP-Verbindung benötigen Sie eine Reihe von Angaben und Daten, die Sie für diesen Zweck über excav als Dienstleister erhalten.

Eine wichtige Voraussetzung ist ein Internetzugang. Damit das Tablet die externen Korrekturdaten über NTRIP abrufen kann, muss eine Datenverbindung vorhanden sein (z. B. Mobilfunk oder SIM-Karte). excav bietet hierzu einen SIM-Karten-Service an, um eine Datenverbindung zu ermöglichen.
...
Wenn Sie die Einrichtung erfolgreich abgeschlossen haben, können Sie mit dem Aufbau des Systems fortfahren. Weitere Informationen finden Sie im nächsten Schritt der Anleitung: [System aufbauen](https://docs.excav.de/System aufbauen/System aufbauen/)
